    ...
    <ul class="contacts-list">
        <li class="active">
            <a href="#">
                ...
                <span class="display-name">Zwazius Zwaziauskas</span>
            </a>
            <div class="contact-actions">
                <button class="action btn btn-info"><i class="glyphicon glyphicon-info-sign"></i></button>
            </div>
        ...
        <li>
            <a href="#">
                ...
                <span class="display-name">Zwaze Zwaziene</span>
            </a>
            <div class="contact-actions">
                <button class="action btn btn-info"><i class="glyphicon glyphicon-info-sign"></i></button>
            </div>
...
<div class="main-content">
    <div class="profile-view">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="contact-actions">
                    <a href="#" class="action btn btn-success btn-xs"><i class="glyphicon glyphicon-plus"></i><span class="text">add contact</span></a>
                </div>
            </div>
        </div>
    </div>
