...
<div class="container">
    <form>
        ...
        <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="register-first-name" value="hwazaazius" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
            ...
            <div class="col-sm-6">
                <fieldset>
                    <legend>Hwazaaz information:</legend>
                    <div class="form-group has-error">
                        <label class="control-label" for="register-username">Hwazaah Name<span class="required">*</span></label>
                        <input type="text" class="form-control" id="register-username" value="sup" required>
                        <p class="help-block">Your Hwazaah Name must be between 6-32 characters, start with a letter and contain only letters and numbers (no spaces or special characters).</p>
